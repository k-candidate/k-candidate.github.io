...
The silver lining is that I found some good sources and picked up some new tricks, e.g.:
- [https://github.com/bryansteiner/gpu-passthrough-tutorial](https://github.com/bryansteiner/gpu-passthrough-tutorial)
- [https://github.com/coderobe/VBiosFinder](https://github.com/coderobe/VBiosFinder)
- [https://github.com/kyokenn/vbios_from_reg](https://github.com/kyokenn/vbios_from_reg)
